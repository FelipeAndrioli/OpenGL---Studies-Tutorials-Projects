...
class Camera {
    public:
        ...
        // processes input received from any keyboard-like input system. Acceptsi input
        // parameter in the form of camera defined ENUM (to abstract it from windowing
        // systems) 
        void ProcessKeyboard(Camera_Movement direction, float deltaTime);

        // Process input received from a mouse input system. Expects the offset value
        // in both the x and y direction
        void ProcessMouseMovement(float xoffset, float yoffset, GLboolean constrainPitch);       

        // Process input received from a mouse scroll-wheel event. Only requires input 
